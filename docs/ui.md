...
## 5. FAQ
Компонент аккордеона для часто задаваемых вопросов с градиентным бордером при наведении и плавными анимациями.

- **Путь**: `resources/js/Components/FAQ.tsx`
- **Использование**: На лендингах и информационных страницах.
- **Особенности**: Премиальный дизайн (`pricing-item`), анимации раскрытия.
